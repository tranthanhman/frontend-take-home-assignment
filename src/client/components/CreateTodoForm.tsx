  ...
  return (
    <form className="group flex items-center justify-between rounded-12 border border-gray-200 py-2 pr-4 focus-within:border-gray-400">
      ...
      <button
        ...
        className="rounded-full bg-gray-700 px-5 py-2 font-sans text-sm font-bold text-white transition-all duration-150 hover:bg-gray-700/70"
